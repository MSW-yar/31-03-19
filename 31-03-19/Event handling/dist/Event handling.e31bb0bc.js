...
// }
// createElement('input')
var getParent = document.getElementById('app');
var newElement = creation('p');
...
var textnod = texting('ELements apended');
adding(newElement, textnod);
var getButton = creation('button');
adding(getParent, getButton);
var gettextnod = texting('New button');
adding(getButton, gettextnod);

getButton.onclick = function (event) {
  var newone = creation('h1');
  adding(getParent, newone);
  var getinp = document.getElementById('input');
...
var getinp = creation('input');
getinp.id = 'input';
adding(getParent, getinp); // getinp.oninput = function (event){
...
//# sourceMappingURL=/Event%20handling.e31bb0bc.js.map